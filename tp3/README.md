...
```
adresse mac de: john - 08:00:27:fe:fb:43
                marcel - 08:00:27:95:6e:fb
```
- prouvez que l'info est correcte (que l'adresse MAC que vous voyez dans la table est bien celle de la machine correspondante)
  - une commande pour voir la MAC de `marcel` dans la table ARP de `john`
  ```
  $ ip neigh show 10.3.1.11
  10.3.1.11 dev enp0s8 lladdr 08:00:27:fe:fb:43 STALE
  ```
  - et une commande pour afficher la MAC de `marcel`, depuis `marcel`
  ```
  $ ip neigh show 10.3.1.12
  10.3.1.12 dev enp0s8 lladdr 08:00:27:95:6e:fb STALE
  ```
